...
if uploaded_file and api_key:
    ...
    # Modificaciones (¡nueva sección!)
    prompt_modificaciones = (
        "Del siguiente texto de contrato, extrae todas las referencias a modificaciones, ampliaciones, reducciones, ajustes de monto, cambio de plazos, procedimientos para modificar el contrato, requisitos para modificaciones y condiciones bajo las cuales es posible modificar cualquier parte del contrato. Copia el texto tal como aparece y da el mayor contexto posible."
        "\n\nTexto:\n" + full_text
    )
    response_modificaciones = openai.chat.completions.create(
        model="gpt-4o",
        messages=[
            {"role": "system", "content": "Eres experto en contratos. Devuelve solo la lista de modificaciones y sus condiciones."},
