...
La IA extrae y consolida los **elementos legales más importantes** del contrato, y realiza una segunda revisión enfocada en los datos críticos para máxima precisión.

**Necesitas tu clave de API de [OpenAI](https://platform.openai.com/api-keys)**
""")

st.warning(
    "⚠️ Esta app funciona con contratos PDF digitales o escaneados (imagen). "
    "El análisis detallado puede tardar y consumir créditos de tu API Key. "
